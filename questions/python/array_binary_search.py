class Solution:
    ...
    def binary_search_recursive_helper(self, array, target, left_index, right_index):
        ...
        if target == potential_match:
            ...
            return self.binary_search_recursive_helper(array, target, left_index, middle_index - 1)
        else:
            return self.binary_search_recursive_helper(array, target, middle_index + 1, right_index)
